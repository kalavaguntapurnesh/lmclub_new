  ...
  <div className="lg:pt-28 pt-16">
    ...
    <section className="my-8 border border-gray-300 rounded p-6">
      ...
      <div className="text-left">
        ...
        <p className="mt-2  text-gray-600">LM Club may update these Terms and Conditions at any time. Members will be notified of significant changes via email or in-app notifications. Continued participation in the LM Grow Rewards program constitutes acceptance of the updated terms.</p>
        
        <p className="mt-6  text-gray-600">By participating in LM Grow Rewards, you confirm that you have read, understood, and agreed to these Terms and Conditions.</p>

        <p className="mt-4  text-gray-600">For questions or support, contact us at <a href="mailto:support@lmclub.com" className="text-blue-600">support@lmclub.com</a>.</p>
      </div>
      </section>
