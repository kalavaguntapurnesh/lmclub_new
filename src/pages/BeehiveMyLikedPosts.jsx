...
const BeehiveMyLikedPosts = () => {
  ...
  const fetchPosts = async () => {
    try {
      const response = await axios.get(backendUrl + `/api/beehive/fetching-all-liked-posts/${userData._id}`);
...
export default BeehiveMyLikedPosts