                    ...
                    <div className="text-gray-600 space-y-2 md:text-start text-center">
                      ...
                      <p>
                        ...
                        <a
                          ...
                          href={`/widget-terms-and-conditions/estore`}
                        >
                      ...
                      <tbody className="text-gray-600">
                        <tr className="border border-gray-300">
                          <td className="p-3 border border-gray-300">
                            <span className="font-semibold text-gray-900">
                              Use a Legitimate Bank Account:
                            </span>{" "}
                            Ensure your earnings are transferred to a valid bank
                            account under your name.
                          </td>
                          <td className="p-3 border border-gray-300">
                            <span className="font-semibold text-gray-900">
                              Do Not Use Fraudulent Accounts:
                            </span>{" "}
                            Avoid creating fake accounts or purchases to
                            manipulate earnings.
                          </td>
                        </tr>
                        ...
                        <tr className="border border-gray-300">
                          <td className="p-3 border border-gray-300">
                            ...
                            Keep track of your earnings and report them to
                            relevant tax authorities as required by law.
                          </td>
                          <td className="p-3 border border-gray-300">
                            <span className="font-semibold text-gray-900">
                              Do Not Spam:
                            </span>{" "}
                            Refrain from spamming your E-Store link across
                            social media or sending unsolicited messages.
                          </td>
                        </tr>
                        ...
                        <tr className="border border-gray-300">
                          <td className="p-3 border border-gray-300">
                            <span className="font-semibold text-gray-900">
                              Share Your Unique E-Store Link:
                            </span>{" "}
                            Promote your personal link to track purchases and
                            earnings accurately.
                          </td>
                          <td className="p-3 border border-gray-300">
                            <span className="font-semibold text-gray-900">
                              Do Not Misrepresent Products:
                            </span>{" "}
                            Provide accurate and truthful information about the
                        ...
                        <tr className="border border-gray-300">
                          <td className="p-3 border border-gray-300">
                            ...
                            Share the benefits of LM Club products honestly to
                            encourage purchases.
                          </td>
                          <td className="p-3 border border-gray-300">
                            <span className="font-semibold text-gray-900">
                            ...
                            Avoid aggressive or deceptive marketing tactics to
                            generate sales.
                          </td>
                        </tr>
                        ...
                        <tr className="border border-gray-300">
                          <td className="p-3 border border-gray-300">
                            ...
                            Monitor your sales and profits using the E-Store
                            dashboard.
                          </td>
                          <td className="p-3 border border-gray-300">
                            <span className="font-semibold text-gray-900">
                            ...
                            Ensure that any promotional materials comply with
                            copyright laws and LM Club guidelines.
                          </td>
                        </tr>
                        ...
                        <tr className="border border-gray-300">
                          <td className="p-3 border border-gray-300">
                            ...
                            Adhere to all LM Club policies and ensure your
                            promotions are consistent with our brand values.
                          </td>
                          <td className="p-3 border border-gray-300">
                            <span className="font-semibold text-gray-900">
                              Do Not Fail to Report Income:
                            </span>{" "}
                            Neglecting to report taxable earnings may result in
                            penalties or program termination.
                          </td>
                        </tr>
                      </tbody>
                    </table>
