                ...
                <div>
                  ...
                  <ul className="list-decimal list-inside ml-6 mt-2  text-gray-600">
                    ...
                    <li>
                      ...
                      Keep track of your earnings and report them to relevant
                    ...
                    <li>
                      ...
                      Promote your personal link to track purchases and earnings
                      accurately.{" "}
                    </li>
                    <li>
                      <span
                    ...
                    <li>
                      ...
                      Adhere to all LM Club policies and ensure your promotions
                      are consistent with our brand values.{" "}
                    </li>
                  </ul>
                  ...
                  <ul className="list-decimal list-inside ml-6 mt-2  text-gray-600">
                    <li>
                      ...
                      Avoid creating fake accounts or purchases to manipulate
                      earnings.
                    </li>
                    <li>
                      <span
                      ...
                      Refrain from spamming your E-Store link across social
                      media or sending unsolicited messages.
                    </li>
                    <li>
                      <span
                        className="font-semibold"
