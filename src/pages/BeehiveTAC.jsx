  ...
  <div className="lg:pt-28 pt-16">
    ...
    <section className="my-8 border border-gray-300 rounded p-6">
      <div className="flex flex-col items-center text-center mb-6">
        ...
        <h1 className="text-3xl font-bold"style={{ color: "#1a1a1a" }}>Beehive Widget Terms & Conditions</h1>
      </div>
      ...
      <div className="text-left">
        <h2 className="text-2xl font-bold mb-4 text-green-600"style={{ color: "#1a1a1a" }}>LM Club Beehive Widget Terms and Conditions</h2>
        ...
        <p className="mt-2"></p>
        <ul className="list-decimal list-inside ml-6 mt-2  text-gray-600">
          <li><span className="font-semibold"style={{ color: "#1a1a1a" }}>Earning Points:</span> Points are earned by sharing deals, engaging with member-shared content, and other eligible activities.</li>
          <li><span className="font-semibold"style={{ color: "#1a1a1a" }}>Redeeming Points: </span> Points can be redeemed for rewards such as gift cards, discounts, or exclusive offers.</li>
          <li><span className="font-semibold"style={{ color: "#1a1a1a" }}>Resetting Points: </span>  Redeemed points reset to zero. Unredeemed points may expire after a specified period (as determined by LM Club policies).</li>
          <li><span className="font-semibold"style={{ color: "#1a1a1a" }}>Non-Transferability:</span> Points are non-transferable and cannot be exchanged for cash.</li>
        ...
        <p className="mt-2  text-gray-600 font-semibold"style={{ color: "#1a1a1a" }}>LM Club reserves the right to terminate access to the Beehive Widget for:</p>
        <div className="ml-10 mt-2  text-gray-600">
        ...
        <p className="mt-2  text-gray-600">LM Club may update these Terms and Conditions at any time. Members will be notified of significant changes via email or in-app notifications. Continued use of the Beehive Widget constitutes acceptance of the updated terms.</p>
        
        <p className="mt-6  text-gray-600">By unlocking and using the Beehive Widget, you confirm that you have read, understood, and agreed to these Terms and Conditions.</p>
