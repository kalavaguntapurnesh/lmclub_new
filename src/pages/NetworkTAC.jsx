  ...
  <div className="lg:pt-28 pt-16">
    ...
    <section className="my-8 border border-gray-300 rounded p-6">
      ...
      <div className="text-left">
        ...
        <p className="mt-2  text-gray-600">LM Club may update these Terms and Conditions at any time. Members will be notified of significant changes via email or in-app notifications. Continued use of the Network Widget constitutes acceptance of the updated terms.</p>
        
        <p className="mt-6  text-gray-600">By participating in the LM Club Network Widget, you confirm that you have read, understood, and agreed to these Terms and Conditions.</p>
