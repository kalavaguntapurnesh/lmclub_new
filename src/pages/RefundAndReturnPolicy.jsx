              ...
              <div className="p-4">
                <section className="my-8 border border-gray-300 rounded">
                  ...
                  <div className="flex flex-col gap-2 mb-4">
                    <h1 className="mx-3 text-xl font-medium">Overview</h1>
                    <div className="ml-4">
                      <h1 className="mx-3 text-base text-[#43474e]">
                        Our refund and returns policy lasts 30 days. If 30 days
                        have passed since your purchase, we can't offer you a
                      ...
                      <h1 className="mx-3 text-base text-[#43474e]">
                        <ul className="list-disc pl-7 p-2">
                          ...
                          <li>
                            CD, DVD, VHS tape, software, video game, cassette
                            tape, or vinyl record that has been opened.
                          </li>
                          <li>
                            Any item not in its original condition, is damaged
                  ...
                  <div className="flex flex-col gap-2 mb-4">
                    <h1 className="mx-3 text-xl font-medium">Refunds</h1>
                    <div className="ml-4">
                      <h1 className="mx-3 text-base text-[#43474e]">
                      ...
                      <div className="ml-4">
                        ...
                        <h1 className="mx-3 text-base text-[#43474e]">
                          ...
                          <a
                            href="richard8445@gmail.com"
                            className="text-green-600 hover:underline"
                          >
                            richard8445@gmail.com.
                          </a>
                        </h1>
                      </div>
                      <h1 className="mx-3 text-xl font-medium">Sale items</h1>
                      <div className="ml-4">
                        <h1 className="mx-3 text-base text-[#43474e]">
                  ...
                  <div className="flex flex-col gap-2 mb-4">
                    <h1 className="mx-3 text-xl font-medium">Exchanges</h1>
                    <div className="ml-4">
                      <h1 className="mx-3 text-base text-[#43474e]">
                  ...
                  <div className="flex flex-col gap-2 mb-4">
                    <h1 className="mx-3 text-xl font-medium">Gifts</h1>
                    <div className="ml-4">
                      <h1 className="mx-3 text-base text-[#43474e]">
                        If the item was marked as a gift when purchased and
                        shipped directly to you, you'll receive a gift credit
                        for the value of your return. Once the returned item is
                        received, a gift certificate will be mailed to you.
                      </h1>
                      <h1 className="mx-3 text-base text-[#43474e]">
                        If the item wasn't marked as a gift when purchased, or
                        the gift giver had the order shipped to themselves to
                        give to you later, we will send a refund to the gift
                        giver and they will find out about your return.
                      </h1>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-2 mb-4">
                    ...
                    <div className="ml-4">
                      ...
                      <h1 className="mx-3 text-base text-[#43474e]">
                        If you are returning more expensive items, you may
                        consider using a trackable shipping service or
                        purchasing shipping insurance. We don't guarantee that
                  ...
                  <div className="flex flex-col gap-2 mb-8">
                    <h1 className="mx-3 text-xl font-medium">Need Help?</h1>
                    <div className="ml-4">
                      <h1 className="mx-3 text-base text-[#43474e]">
                        Contact us at{" "}
                        <a
