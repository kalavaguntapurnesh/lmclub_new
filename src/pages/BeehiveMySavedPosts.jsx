...
const BeehiveMySavedPosts = () => {
  ...
  const fetchPosts = async () => {
    try {
      const response = await axios.get(backendUrl + `/api/beehive/fetching-all-saved-posts/${userData._id}`);
                        ...
                        {currentPosts.length > 0 ? (
                          currentPosts.map((post, index) => (
                            <tr key={index} className="hover:bg-gray-100">
                              ...
                              <td className="border text-center border-gray-300 px-4 py-2">
                                <button
                                  onClick={() => openModal(post?.beehivePostId)}
                              ...
                              <td className="border text-center border-gray-300 px-4 py-2 text-zinc-600 text-sm">
                                {likes[post?.beehivePostId?._id] || 0} 
                              </td>
                              <td className="border text-center border-gray-300 px-4 py-2 text-zinc-600 text-sm">
                                0
                              </td>
...
export default BeehiveMySavedPosts
